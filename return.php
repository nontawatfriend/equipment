...
<thead style="background-color: #e7e7e7">
 ...
 <th width="18%"><h4>ชื่อผู้ใช้</h4></th>
 <th width="18%"><h4>ในวันที่</h4></th>
 <th width="20%"><h4>ถึงวันที่</h4></th>
 <th width="18%"><h4>ผู้อนุมัติ</h4></th>
 <th width="12%"><h4>สถานะการยืม</h4></th>
 </tr>
</thead>
<tbody>
<?php
$sql="select * from tb_servicedetails where user_id='$_SESSION[EMPID]' and status_id='3'";
$result=$db->query($sql);
...
?>
 ...
 <td><?=$row["userapprove_id"]?></td>
	 <td><a href="?page=return_detail&servicedetail_id=<?=$row["servicedetail_id"];?>"><span class="btn btn-default"><i class="fa fa-search"></i> ตรวจสอบ</span></a></td>
<?php } ?>
 </tr>
</tbody>
</table>
